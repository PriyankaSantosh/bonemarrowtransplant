...
for(String bow:han)
{
	...
	driver.findElement(By.xpath("//input[@id='edit-submit']")).click();
	driver.get("https://dev.bmtplus.com/stock-reports");
	driver.findElement(By.xpath("//div[@id='edit_stores_chosen']/a/span")).click();
	driver.findElement(By.xpath("//li[text()='Test Centre (TSA)']")).click();
	Thread.sleep(4000);
	driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys(name);
	driver.findElement(By.xpath("//div[@id='edit_items_chosen']/div/ul/li")).click();
