...
import org.testng.annotations.Test;
	...
	public class UpdateHlaStatus {
		...
		@Test
		public void UpdateHlaStatus() throws InterruptedException 
		{
		...
		//	driver.findElement(By.xpath("//input[@id='edit-field-patient-uhid-und-0-value']")).sendKeys("test1478");
			...
			driver.findElement(By.xpath("//a[@id='quicktabs-tab-patient_summary_pre_bmt-4']")).click();
			Thread.sleep(5000);
			driver.findElement(By.xpath("//div[@id='quicktabs-tabpage-patient_summary_pre_bmt-4']/div/div/div/span/a")).click();
	}
